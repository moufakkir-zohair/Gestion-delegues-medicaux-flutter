...
import 'package:gestion_delegue/Pages-Admin/Medicament/Ajouter-Medicament.dart';
import 'package:gestion_delegue/Pages-Admin/Medicament/Detail-Medicament.dart';
import 'dart:convert';
import 'package:http/http.dart' as http;

class Liste_Medicament extends StatelessWidget{
  ...
  Liste_Medicament({this.nbreDoctor=" ",this.nbreDelegue=" ",this.nbreMedicament=" ",this.Nom=" ",this.Prenom=" ",this.Email=" "});
  Future<List> getData() async{
    final response= await http.get("http://192.168.1.67:80/Admin/Medicament/Liste_medicament.php");
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: ()=>Navigator.of(context).push(
          MaterialPageRoute(
            builder: (BuildContext context)=>Ajouter_Medicament(),
          ),
        ),
          ...
          return new Card(
            ...
            child: new ListTile(
              ...
              leading: ConstrainedBox(
                ...
                child: Image.asset("assets/images/medicament.png", fit: BoxFit.cover),
              ),
              title:Text(list[i]['Code'],),
              subtitle: Text(list[i]['Nom_medi']+"\n"+list[i]['Date_Exp'],),
              onTap: ()=>Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (BuildContext context)=>Detail_Medicament(list:list,index:i),
                ),
              ),
            ),
            color: Colors.white ,

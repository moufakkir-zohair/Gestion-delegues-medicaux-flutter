...
import 'package:gestion_delegue/Pages-Admin/Docteur/Modifier-Docteur.dart';
import 'package:http/http.dart' as http;


class Detail_Docteur extends StatefulWidget {
  final List list;
  final int index;
  Detail_Docteur({this.list , this.index});
  @override
  _Detail_DocteurState createState() => _Detail_DocteurState();
}

class _Detail_DocteurState extends State<Detail_Docteur> {
      ...
      child: Padding(
        ...
        child: RaisedButton(
            ...
            onPressed: ()=>Navigator.of(context).push(
              MaterialPageRoute(builder: (BuildContext context)=>Modifier_Docteur(list: widget.list,index:widget.index)),
            ),
  ...
  void delete() async{
    var url ="http://192.168.1.67:80/Admin/Docteur/Delete_docteur.php";
  ...
  void confirm(){
    AlertDialog alertDialog = new AlertDialog(
      ...
      content: Text("Vous voulez vraiment supprimer ce médecin!!!",style: TextStyle(color: Colors.red),),
      actions: <Widget>[
        MaterialButton(
          ...
          onPressed: () {
            ...
            Navigator.of(context).push(
              MaterialPageRoute(
                  builder: (BuildContext context) => Liste_Docteur()),
            );
          }
        ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            InkWell(
                              child: Text(
                                "${widget.list[widget.index]['specialite']}",
                                style: TextStyle(
                                    color: new Color(0xffffffff),
                                    fontSize: 18.0),
                              ),

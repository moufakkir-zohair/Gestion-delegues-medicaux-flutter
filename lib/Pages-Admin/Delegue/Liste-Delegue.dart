...
class Liste_Delegue extends StatelessWidget{
  final String Nom;
  final String Prenom;
  final String Email;
  ...
  Liste_Delegue({this.nbreDoctor=" ",this.nbreDelegue=" ",this.nbreMedicament=" ",this.Nom=" ",this.Prenom=" ",this.Email=" "});
  Future<List> getData() async{
    final response= await http.get("http://192.168.1.67:80/Admin/Delegue/Liste_delegue.php");
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: ()=>Navigator.of(context).push(
          MaterialPageRoute(
            builder: (BuildContext context)=>Ajouter_Delegue(),
          ),
        ),
          ...
          return new Card(
            ...
            child: new ListTile(
              ...
              leading: ConstrainedBox(
                ...
                child: Image.asset("assets/images/delegue.png", fit: BoxFit.cover),
              ),
              title:Text(list[i]['nom']+" "+list[i]['prenom'],),
              subtitle: Text(list[i]['email']+"\n"+list[i]['Numero_tele'],),
              onTap: ()=>Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (BuildContext context)=>Detail_Delegue(list:list,index:i),
                ),
              ),
            ),
            color: Colors.white ,

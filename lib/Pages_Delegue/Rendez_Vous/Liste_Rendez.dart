...
class Liste_Rendez extends StatelessWidget{
  ...
  Liste_Rendez({this.nbreRapport=" ",this.nbreVoyage=" ",this.nbreRendez=" ",this.nbreCommande=" ",this.Nom,this.Prenom,this.Email});

  Future<List> getData() async{
    final response= await http.post("http://192.168.1.67:80/Delegue/Liste_events.php",body: {
    "email":Email,
    });
          ...
          return new Card(
            ...
            child: new ListTile(
              ...
              leading: ConstrainedBox(
                ...
                child: Image.asset("assets/images/rendez.png", fit: BoxFit.cover),
              ),
              title:Text("Sujet: "+list[i]['sujet'] , style: TextStyle(color: Colors.blue, fontSize: 17),),
              subtitle: Text("Docteur: "+list[i]['docteur']+"\nDate de début: "+list[i]['date_d']+"\nDate de fin: "+list[i]['date_f'],),
